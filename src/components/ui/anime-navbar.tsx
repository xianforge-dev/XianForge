                    ...
                    {items.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                href={item.url}
                                onClick={(e) => {
                                    // If it's a hash link, handle it manually to set active tab
                            ...
                            >
                                {isActive && (
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-gold-500/25 rounded-full blur-md" />
                                        <div className="absolute inset-[-4px] bg-gold-500/20 rounded-full blur-xl" />
                                        <div className="absolute inset-[-8px] bg-gold-500/15 rounded-full blur-2xl" />
                                        <div className="absolute inset-[-12px] bg-gold-500/5 rounded-full blur-3xl" />
